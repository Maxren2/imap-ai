...
import { triggerBackfill, getLatestHomeBackgroundRuns, getInboxMessages } from "./mail-actions";
...
export default async function HomePage() {
  const [account, inboxCount, threadMessages, inbox, backgroundRuns] = await Promise.all([
  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-8">
      ...
      <div className="mt-6">
        <ThreadList messages={threadMessages} totalCount={inboxCount} pageSize={INBOX_PAGE_SIZE} />
      </div>
    </main>
  );
}
