...
// Ported from inbox-zero's real components/ui/empty.tsx (part of the
// visual-polish backlog, DESIGN.md section 33) -- imap-ai's empty states
// were previously plain unstyled <p> tags.
